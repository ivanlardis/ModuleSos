...
class IncidentCompleteItemView(value: FBModel,  onClickListener: (ItemView<FBModel>) -> Unit?) : ItemView<FBModel>(value, onClickListener) {
    ...
    override fun bind(view: View) {
        ...
        with(view)
        {
            ...
            incidents_activity_complete_item_text_view_time.text=DATE_FORMAT.format(value.compeleteTime)
            incidents_activity_complete_item_text_view_description.text="Ура проблемма решена"
        }
    }
}