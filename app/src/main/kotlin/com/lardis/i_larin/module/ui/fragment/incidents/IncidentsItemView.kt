...
class IncidentsItemView(value: IncidentsViewModel) : ItemView<IncidentsViewModel>(value, {}) {
    ...
    override fun bind(view: View) {
        ...
        with(view)
        {
            value.userModel?.firstName.let {    incidents_fragment_item_edit_text.text =it}
            Picasso.with(context)
                    .load(value.userModel?.photo50)
